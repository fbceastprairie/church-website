      ...
      <section className="relative h-[80vh] flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            {/* Secondary Button: Facebook Blue - Hidden on mobile to prevent overlap with service bar */}
            <a href={CHURCH_INFO.facebookUrl} target="_blank" rel="noreferrer" className="hidden md:flex bg-[#1877F2] hover:bg-[#166fe5] text-white px-8 py-4 rounded-full font-bold transition-all transform hover:scale-105 shadow-xl items-center gap-3 text-lg">
